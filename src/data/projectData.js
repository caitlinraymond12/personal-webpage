...
const projects = [
   ...
   },
   {
      name: "CPU Simulator",
      img: cpuImg,
      description: "Using Verilog, I designed and implemented a CPU simulator that is able to simulate the functionality of a CPU. I designed the ALU, registers, and control unit, and integrated them into a complete CPU design.",
   ...
   },
   {
      ...
      img: stopwatchImg,
      description: "This project was a fun exploration of how to use clock division to create a stopwatch. I designed and implemented a stopwatch that is able to keep track of time and display it on a 7-segment display.",
   ...
   },
   {
      ...
      img: ioImg,
      description: "Utilizing C, I recreated the IO library to better understand how it works under the hood. I implemented functions such as printf, scanf, and fopen, and tested them to ensure that they work correctly.",
   ...
   },
   {
      ...
      img: myShellImg,
      description: "I created a Shell for terminal using C, and implemented various features such as command history, tab completion, and job control.",
